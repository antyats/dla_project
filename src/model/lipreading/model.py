...
from src.model.lipreading.models.resnet import BasicBlock, ResNet
from src.model.lipreading.models.resnet1D import BasicBlock1D, ResNet1D
    ...
    def __init__(
        ...
        if tcn_options:
            ...
            self.tcn = DenseTCN(
                ...
                input_size=(
                    self.backend_out if not self.use_boundary else self.backend_out + 1
                ),
